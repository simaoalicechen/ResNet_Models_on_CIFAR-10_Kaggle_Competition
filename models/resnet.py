...
#     def __init__(self, in_planes, planes, stride=1, with_attention=False):
...
#         self.layer3 = self._make_layer(block, 165, num_blocks[2], stride=2, with_attention=True)
#         self.layer4 = self._make_layer(block, 330, num_blocks[3], stride=2, with_attention=True)
#         self.linear = nn.Linear(330*block.expansion, num_classes)

#     def _make_layer(self, block, planes, num_blocks, stride, with_attention=False):
#         strides = [stride] + [1]*(num_blocks-1)
#         layers = []
#         for stride in strides:
#             layers.append(block(self.in_planes, planes, stride, with_attention))
#             self.in_planes = planes * block.expansion
#         return nn.Sequential(*layers)
...
# def ResNet5MWithAttention():
#     return ResNetWithAttention(BasicBlockWithAttention, [2, 2, 2, 2])
