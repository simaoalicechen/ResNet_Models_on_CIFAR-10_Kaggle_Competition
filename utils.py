...
def plot_losses(train_losses, valid_losses, epoch, hyperparam):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f"kaggle_graphs/losses {' | '.join(hyperparam)} in {epoch} epochs.png")
    plt.close()
...
def plot_acc(train_acc, valid_acc, epoch, hyperparam):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f"kaggle_graphs/acc {' | '.join(hyperparam)} in {epoch} epochs.png")
    plt.close()
...
def plot_lr(lr_trend, epoch, hyperparam):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f"kaggle_graphs/LR {' | '.join(hyperparam)} in {epoch} epochs.png")
    plt.close()
